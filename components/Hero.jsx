    ...
    <section id="hero">
      <div className="hero-content">
        <h1 className="hero-name">
          {personal.name.first}<br />
          <em>{personal.name.last}</em>
        </h1>
        ...
        <div className="hero-links">
          ...
          <div className="hero-link-sep"></div>
          <a href={personal.linkedin} target="_blank" rel="noreferrer" className="hero-link">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="hero-link-sep"></div>
          <a href={`tel:${personal.phone.replace(/\s/g, '')}`} className="hero-link">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.27 2 2 0 0 1 3.59 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.96a16 16 0 0 0 6.13 6.13l.72-.72a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/>
            </svg>
            {personal.phone}
          </a>
        </div>
