  ...
  return (
    <footer>
      <div className="footer-left">
        <svg className="footer-sig-svg" viewBox="0 0 180 70" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Bek signature">
          <path
            className="footer-sig-line"
          ...
          />
          <path className="footer-sig-underline" d="M8 58 L40 58" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" opacity="0.4" />
        </svg>
